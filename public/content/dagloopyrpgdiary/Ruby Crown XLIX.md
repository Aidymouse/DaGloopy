...
_A continual problem this game had was the lack of any sort of mass-combat rules that I liked and new well enough to adjuticate on the fly. Because this plan merited mechanical bonuses. Instead, with time running short, I knew that the fight against the demons probably wasn't going to matter. It would have been nice if it did though, so the effects of this plan were concrete._
...
There is some back and forth, because the giants aren't sure what to make of the humans. The giants have just arrived here apparently of their own volition (_I really love when magic can be confused with happenstance_) and it seems for a moment like they may attack, but a deal is struck between Balthazar and the giants that if they should help attack the demonic army, then they will get one of the Baronies of Orthos to rule.
...
In the coming years...
- The beastman threat is destroyed, burned away by divine white fire.
- It was discovered that Amaratos of Emerald Fronds was attempting to take Orthos without The Pharaoh's knowledge, using a plot involving the beastmen and a magical beast that can control minds called a Golrad. To preserve political relations with Ajira, he is exiled instead of killed. The Powder guild comes under the purview of the O.T.I.A
- Desaune, previously ruled by the vampire Cortier, is reconnected with Orthos and re-enters the kingdom.
- Orthos' borders grow as the dragon disuades all enemies from interfering (unbeknownst to the general public, The Dragon sometimes has fits of disobeying Balthazar)
